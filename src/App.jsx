      ...
      <main className="flex-1 flex flex-col w-full overflow-y-auto">
        ...
        <div className="p-8 flex flex-col gap-6 max-w-[1600px] w-full mx-auto flex-1 print:p-0 print:gap-4 print:max-w-none">
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-stretch">
            ...
            {selectedProjectId === 'overall' && (
              <div className="w-full lg:w-[290px] print:hidden flex-shrink-0 bg-white border border-slate-200 rounded-2xl shadow-xs p-5 flex flex-col gap-4 max-h-[580px] overflow-hidden">
